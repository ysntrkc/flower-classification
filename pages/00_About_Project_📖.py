...
st.markdown(
    "We are going to classify the images using CNN, RESNET-18, DenseNet-121 and EfficientNet-B0 structures."
)
...
st.markdown(
    """
            CNN makes image processing easier by providing us with some useful functions to extract information about images.
...
st.image(
    ...
    caption="Figure 1: Example CNN Architecture",
)
...
st.image(
    "./figures/resnet.png",
    use_column_width=True,
    caption="Figure 2: ResNet-18 Architecture",
)
...
st.image(
    ...
    use_column_width=True,
    caption="Figure 3: DenseNet-121 Architecture",
)
...
st.image(
    "./figures/efficientnet.png",
    use_column_width=True,
    caption="Figure 4: EfficientNet Architecture",
)
